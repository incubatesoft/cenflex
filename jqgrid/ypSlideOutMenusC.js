...
if(this.ie||this.ns4||this.dom)
{
	...
	var d=document;var _8="";_8+="#"+this.id+"Container{visibility:visible;";_8+="left:"+_3+"px;";_8+="top:"+_4+"px;";_8+="overflow:hidden;z-index:10000;}";_8+="#"+this.id+"Container,#"+this.id+"Content{position:absolute;";_8+="width:"+_5+"px;";_8+="height:"+_6+"px;";_8+="clip:rect(0 "+_5+" "+_6+" 0);";_8+="}";this.css=_8;this.load();
	}
	}
...
//alert('hi');
  ...
  if(!d.MM_p) d.MM_p=new Array('images/logo1.jpg','images/1.jpg','images/2.jpg','images/3.jpg','images/4.jpg','images/5.jpg','images/6.jpg','images/7.jpg','images/8.jpg','images/9.jpg','images/edu-img.jpg','images/headerform.jpg','images/studentimg.jpg','images/parentimg.jpg','images/teacherimg.jpg','images/futer1.jpg','images/futer2.jpg','images/features.jpg');
