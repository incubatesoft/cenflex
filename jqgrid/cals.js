...
//alert("hi");
	...
	var todayString = "<font color=white>Select Your Date</font>"
	var weekString = "Wk"
    ...
    */
	...
	function constructYear() {
		...
		if (!yearConstructed) {
			...
			sHTML += "<tr><td align='center' onmouseover='this.style.backgroundColor=\"#FFFFFF\"; this.style.borderColor=\"#666666\"' onmouseout='this.style.backgroundColor=\"\"; this.style.borderColor=\"#FFFFFF\"' style='cursor:pointer; border: 1px solid #ffffff;' bgcolor=#ffffff onmousedown='clearInterval(intervalID2);intervalID2=setInterval(\"incYear()\",30)'	onmouseup='clearInterval(intervalID2)'><img SRC='"+imgDir+"drop1.gif'></img></td></tr>"
   ...
   function WeekNbr(n) {
	...
	{
		//alert(frameOffSetLeft);
		//alert(frameOffSetTop);
