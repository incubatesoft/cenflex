...
$.growlUI = function(title, message, timeout) {
	var $m = $('<div class="growlUI"><img src="'+ base_s_img +'spacer.gif" class="closeme delete_ico icn white" /></div>');
	if (title) $m.append('<h1 class="growlUI_hdr">'+title+'</h1>');
	if (message) $m.append('<h2 class="growlUI_bdy" id="growlUI_bdy">'+message+'</h2>');
...
$.blockUI.defaults = {
    ...
    message:  '<h1 class="block_load"><img src="'+base_spinner+'" />Loading..</h1>',
