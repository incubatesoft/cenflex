<?php
class Branch_ordersgrid extends Controller 
{
...
$result = mysql_query("SELECT COUNT(*) AS count FROM tbl_order_master where active='Yes' and orderto='".$row_branch['branchname']."'".$wh);
...
$SQL = "SELECT  id,donum,orderdate,orderby,priority,packagetype,status,active from tbl_order_master where active='Yes' and orderto='".$row_branch['branchname']."'  ".$wh. " ORDER BY ".$sidx." ". $sord." LIMIT ".$start." , ".$limit;
...
</a>",$row['orderdate'],$row['orderby'],$row['priority'],$row['packagetype'],$stat);
    $i++;
}
