...
echo "<script>window.location.href='".base_url()."index.php/login/loginsuggestion'</script>";
	...
	$this->load->view('factory/cuttingsection_home_test');
...
<td  style='font-family:Verdana, Geneva, sans-serif; font-size:12px; border-bottom:1px solid #000;'  align=center>".$res['colorspecific']."</td></tr>";
	...
	<tr><td style='font-family:arial;font-size:14px;'>Party Name: ".$pdetails['dname']."</td></tr>

	<tr><td style='font-family:arial;font-size:14px;'>Address: ".$pdetails['street1'].$pdetails['street2']."</td></tr>



	<tr><td style='font-family:arial;font-size:14px;'>City: ".$pdetails['city']."</td></tr>

	<tr><td style='font-family:arial;font-size:14px;'>State: ".$pdetails['state']."</td></tr>

	<tr><td style='font-family:arial;font-size:14px;'>Phone: ".$pdetails['phone']." Mobile: ".$pdetails['mobile']."</td></tr>

	<tr><td style='font-family:arial;font-size:14px;'>TIN Number: ".$pdetails['tinnumber']."</td></tr>

	<tr><td style='font-family:arial;font-size:14px;'>ECC: ".$pdetails['ecc']." CST: ".$pdetails['cst']."</td></tr>";
	...
	<tr><td style='font-family:arial;font-size:14px;'>Party Name: ".$pdetails['branchname']."</td></tr>
	...
	<tr><td style='font-family:arial;font-size:14px;'>No:".$rpnum."/".$year."</td><td></td></tr>

	".$partydetails."

	<tr><td style='font-family:arial;font-size:14px;'>Vehicle No:".$vehno['vehiclenumber']."</td><td></td></tr>

	<tr><td style='font-family:arial;font-size:14px;'>Transporter Name:".$vehno['transporter']."</td><td></td></tr>

	<tr><td colspan=2 style=height:15px;padding-right:5px; align=right>Date:".$d."</td></tr>

	<tr><td colspan=2>

	<fieldset style='border:1px solid #073c68'><legend style='font-family:arial;font-size:15px;'><b>Packaging List</b></legend>



	<table cellpadding='3' style='width:100%; font-size:14px' border=0>

	<tr><thead><th style='font-family:arial;font-size:15px;padding:3px;' width=3%>Sno</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=3%>DO Num</th><th style='font-family:arial;font-size:15px; padding:3px;' width=5%>Bundle No</th><th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Length</th><th style='font-family:arial;font-size:15px;padding:3px;' width=5%>width</th><th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Thickness</th><th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Density</th><th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Varaity</th><th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Length</th><th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Width</th><th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Thickness</th><th style='font-family:arial;font-size:14px;padding:3px;' width=10% align=left>Unit.wt(Kgs)</th><th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Qty</th><th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Total.wt(Kgs)</th></thead></tr>
...
$qtype="Nos";
 ...
 if($row['variety']=="B Grade" ||$row['variety']=="C Grade" || $row['variety']=="Skin"  )
	...
	$tab=$tab."<tr><tbody><td style='font-family:arial;font-size:14px;padding:4px;'>".$i."</td>

	<td style=font-family:arial;font-size:14px;padding:4px;>".$row['donum']."</td><td style=font-family:arial;font-size:14px;padding:4px;>".$row['bundlenum']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$lenhght."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$width."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$thickness."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$row['density']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$row['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$lenm."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$widtm."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$thickm."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$ewt."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$quantity."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt."</td></tr><tr><td colspan=2 style=height:10px;></td></tbody></tr>";
...
$tab=$tab."<tr ><td colspan=14 ><hr></hr></td></tr><tr><td></td><td style='font-family:arial;font-size:14px;padding:4px;'><b>Total Bundles </b></td><td style='font-family:arial;font-size:14px;padding:4px;'>".$i."</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td style='font-family:arial;font-size:14px;padding:4px; padding-right:50px;' colspan=4 align=right><b>Total Bundles weight </b>: ".$ttwt."</td></tr></fieldset></td></tr></table>";
	...
	<fieldset style='border:1px solid #073c68;width:400px;'  align=center><legend style='font-family:arial;font-size:15px;'><b>Summary</b></legend>



	<table cellpadding='3' style='width:400px; font-size:14px' border=0 align=center>

	<tr><thead><th style='font-family:arial;font-size:15px;padding:3px;' width=3%>Description</th><th style='font-family:arial;font-size:15px; padding:3px;' width=5%>No.of bundles</th><th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Total.wt(Kgs)</th></thead></tr>
	...
	$res_pack=mysql_query("select *from tbl_packaginglist where variety='".$row_load['variety']."' and density='".$row_load['density']."' and status='New' and qtype='Roll' ");
		...
		$tab=$tab."<tr><td style='font-family:arial;font-size:14px;padding:4px;'>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno." Roll(s)</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt."</td></tr>";
	   ...
	   $res_pack=mysql_query("select *from tbl_packaginglist where variety='".$row_load['variety']."' and density='".$row_load['density']."' and status='New' and qtype='Block'");
		...
		$tab=$tab."<tr><td style='font-family:arial;font-size:14px;padding:4px;'>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno_blocks." Block(s)</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt_blocks."</td></tr>";
		...
		$tab=$tab."<tr><td style='font-family:arial;font-size:14px;padding:4px;'>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno_nos." Nos</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt_nos."</td></tr>";
	 ...
	 $res_pack=mysql_query("select *from tbl_packaginglist where variety='".$row_load['variety']."' and density='".$row_load['density']."' and status='New' and qtype='Grades' ");
		...
		$tab=$tab."<tr><td style='font-family:arial;font-size:14px;padding:4px;' width=10%>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno_gds." Nos</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt_gds."</td></tr>";
	...
	<tr><td style='font-family:arial;font-size:14px;padding:4px;'>Total</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totnum."</td>

	<td style='font-family:arial;font-size:14px;padding:4px;'>".$totwei."</td></tr></table></fieldset></td></tr></table>";
	...
	<tr><th style='font-family:arial;font-size:15px;padding:3px;' width=3%>Sno</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=3%>DO Num</th>

	<th style='font-family:arial;font-size:15px; padding:3px;' width=5%>Bundle No</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Length</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=5%>width</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Thickness</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Density</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=8% align=left>Variety</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=8% align=left>Length</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=8% align=left>Width</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Thickness</th>

	<th style='font-family:arial;font-size:14px;padding:3px;' width=10% align=left>Unit.wt(Kgs)</th>

	<th style='font-family:arial;font-size:15px;padding:3px;' width=10% align=left>Qty</th>

	<th style='font-family:arial;font-size:15px;padding:1px;' width=10% align=left>Total.wt(Kgs)</th></tr>
...
{$quantity=$row['quantity']. " Nos";
 ...
 if($row['variety']=="B Grade" ||$row['variety']=="C Grade" || $row['variety']=="Skin"  )
	...
	$tab1=$tab1."<tr><td style='font-family:arial;font-size:14px;padding:4px;'>".$i."</td>

	<td style=font-family:arial;font-size:14px;padding:4px;>".$row['donum']."</td><td style=font-family:arial;font-size:14px;padding:4px;>".$row['bundlenum']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$lenhght."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$width."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$thickness."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$row['density']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$row['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$lenm."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$widtm."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$thickm."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$ewt."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$quantity."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt."</td></tr>";
...
$tab1=$tab1."<tr ><td colspan=14 ><hr></hr></td></tr><tr><td></td><td style='font-family:arial;font-size:14px;padding:4px;'><b>Total Bundles </b></td><td style='font-family:arial;font-size:14px;padding:4px;'>".$i."</td><td></td><td></td><td></td><td></td><td></td><td></td><td style='font-family:arial;font-size:14px;padding:4px; padding-right:50px;' colspan=4 align=right><b>Total Bundles weight </b>: ".$ttwt."</td></tr></td></tr></table>";
	...
	<tr><th style='font-family:arial;font-size:15px;padding:3px;' width=3%>Description</th><th style='font-family:arial;font-size:15px; padding:3px;' width=5%>No.of bundles</th><th style='font-family:arial;font-size:15px;padding:3px;' width=5%>Total.wt(Kgs)</th></tr>
	...
	$res_pack=mysql_query("select *from tbl_packaginglist where variety='".$row_load['variety']."' and density='".$row_load['density']."' and status='New' and qtype='Roll' ");
		...
		$tab1=$tab1."<tr><td style='font-family:arial;font-size:14px;padding:4px;'>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno." Roll(s)</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt."</td></tr>";
	   ...
	   $res_pack=mysql_query("select *from tbl_packaginglist where variety='".$row_load['variety']."' and density='".$row_load['density']."' and status='New' and qtype='Block'");
		...
		$tab1=$tab1."<tr><td style='font-family:arial;font-size:14px;padding:4px;'>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno_blocks." Block(s)</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt_blocks."</td></tr>";
		...
		$tab1=$tab1."<tr><td style='font-family:arial;font-size:14px;padding:4px;'>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno_nos." Nos</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt_nos."</td></tr>";
	 ...
	 $res_pack=mysql_query("select *from tbl_packaginglist where variety='".$row_load['variety']."' and density='".$row_load['density']."' and status='New' and qtype='Grades' ");
		...
		$tab1=$tab1."<tr><td style='font-family:arial;font-size:14px;padding:4px;' width=10%>".$row_load['density']."&nbsp;&nbsp;&nbsp;".$row_load['variety']."</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totno_gds." Nos</td><td style='font-family:arial;font-size:14px;padding:4px;'>".$totwt_gds."</td></tr>";
	...
	<td style='font-family:arial;font-size:14px;padding:4px;'>".$totwei."</td></tr></td></tr></table></table>";
