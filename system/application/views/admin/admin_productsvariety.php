...
$(document).ready(function(){
	...
	$('#productsvarietyForm').submit(function(e) {
...
//alert("hi");
	...
	$.ajax({
		type: "POST",
		 url: base_url+'admin/admin_modules/productsvarietysubmit',
		data: $('#productsvarietyForm').serialize(),
		
		success: function(msg)
		{
			if(msg=='Product variety Registered Successfully.')
{
$( "#productsvarietyForm" )[ 0 ].reset();
}
				success(1,msg);
...
<tr><td align="right" style="padding-right:100px; padding-top:20px;"><a href=" <?php echo base_url(); ?>index.php/admin/admin_modules/productvarietyview"><img src="<?php echo base_url(); ?>images/vvv.gif"  style="border:none"/></a></td></tr>

<tr><td class="success" id=success ></td></tr>
<tr><td>
<form name="productsvarietyForm" id="productsvarietyForm" action="" method="post">
<fieldset style="border:1px solid #073c68;width:420px;"><legend><b>Product&nbsp;Varieties&nbsp;Registration</b></legend>
<table  cellpadding="3" cellspacing="1" height="100%">
<tr><td>Product Name:</td><td style="padding-left:30px"><select name="pname" id="pname" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; border:1px solid #073c68 " />
...
<tr><td>Product Variety:</td><td style="padding-left:30px"><input type="text" size="30" name="pvname" id="pvname" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; border:1px solid #073c68" /></td></tr>
