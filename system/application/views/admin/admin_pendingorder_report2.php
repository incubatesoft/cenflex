...
<td align="right" style="padding-right:20px; padding-top:20px;"><a href=" <?php echo base_url(); ?>index.php/admin/admin_orders/pendingordersprintview/<?php echo $vars?>" target="_blank" id="print"><img src="<?php echo base_url(); ?>images/print.gif"  style="border:none"/></a></td></tr>
<tr><td><br /></td></tr>
...
{ //alert('hi');
	...
	if(obj == "ho")
	{
			$.ajax({
			type: "POST",
			url: base_url+"admin/admin_reports/pendingwise_other_ho_report/",
		 //	data: query_str,
			beforeSend: function(){
	...
	$.ajax({
			type: "POST",
			url: base_url+"admin/admin_reports/pendingwise_report/"+obj,
		 //	data: query_str,
			beforeSend: function(){
					document.getElementById('dynamictable').innerHTML = "<img src='<?php echo base_url(); ?>images/loading2.gif' alt='loading'  />";				  		  
			// $("#add_admin_shipping1 .frmholder").html($(".spinner").clone());
