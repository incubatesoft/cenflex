...
$finaltotalbundles=0;
$finaltotalmtrs=0;;
//echo "select * from tbl_order_master where orderdate='".$str."'  ORDER BY id desc";
...
<tr><td colspan="8" style="height:1px; background-color:#003"></td></tr>
<!--
<tr><th colspan="3">Total Bundles</th><th align="center"><?php echo $finaltotalbundles?></th><th align="center"><?php echo $totaldispatched?></th><th align="center"><?php echo $totalpendingbundles?></th><th width=150 align=center></th></tr>-->
</table>
