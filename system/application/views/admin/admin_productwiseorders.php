...
$finaltotalbundles=0;
$finaltotalmtrs=0;
$str=mysql_query("select distinct density,variety from tbl_orders");
...
//echo "select *from tbl_orders where density='".$row1['density']."' and variety='".$row1['variety']."' and itemname='Sheets' ";
...
//echo "select *from tbl_orders where density='".$row1['density']."' and variety='".$row1['variety']."' where itemname='Cushions' ";
//echo "select *from tbl_orders where donum='".$row1['donum']."'";
