...
//alert(gr); 
    ...
    url:base_url+'admin/admin_distributorsgrid',
    ...
    colNames:['id','Customer Code','Type','Name','Contact Name','Mobile','Land Phone','Street1','street2','City','State','Pin Code','ECC','CST','Tin Number','Edit','Delete'],
    ...
    colModel:[
        ...
        {name:'dcode',index:'dcode', width:100,editable:true},
		{name:'customertype',index:'customertype', width:100,editable:true},
		 {name:'dname',index:'dname', width:100,editable:true},
		  {name:'name',index:'name', width:100,editable:true},
		  {name:'mobile',index:'mobile', width:60,editable:true},
		   {name:'phone',index:'phone', width:60,editable:true},
		    {name:'street1',index:'street1', width:80,editable:true},
			{name:'street2',index:'street1', width:80,editable:true},
...
$("#dialog_message").dialog(
{
		...
		buttons: { 
				"Ok": function() 
				{
					...
					$.ajax({
					type: "POST",
					url: base_url+"admin/admin_modules/distributors_delete/"+jQuery("#list5").getGridParam('selrow'),			 
					beforeSend: function()
					{
...
function  delete_distributor(obj)
{
 		$(this).closest("td").unbind("click");
		// alert($(obj).attr("ship_no"));
		$("#game_idval").val($(obj).attr("id"));
		var msg="Are you sure you want to delete this Distributor ?";
 ...
 function  edit_distributor(obj)
 {
 	//alert('hi');	//alert('ffff');
		//alert($(obj).attr("ship_no"));
		
		$("#add_admin_shipping").width(570).height(500);
		
		//$(this).closest("td").unbind("click");
 		
		$.blockUI({message: $("#add_admin_shipping")});
		
		$("#add_admin_shipping .modal_title").html("Edit Distributor");
		
		  var query_str = "";
		  	$.ajax({
			type: "POST",
			url: base_url+"admin/admin_modules/editdistributor/"+obj,
		 //	data: query_str,
			beforeSend: function(){
...
<tr><td  width=100% style="padding-left:10px;">
