...
<tr><td align="center" style="padding-top:20px;" width="30%">From Date&nbsp;<input type="text" size="26" name="fdate" id="fdate" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; " value='<?php echo $str1[0] ?>'></td><td style="padding-top:20px; padding-left:10px;">To Date&nbsp;<input type="text" size="26" name="tdate" id="tdate" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; " value='<?php echo $str1[1] ?>'></td></tr>
...
//echo "select * from tbl_order_master where orderdate=IN('".$str[0]."','".$str[1]."') ORDER BY id desc";
