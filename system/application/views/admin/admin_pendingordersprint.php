...
$allfinaltotalmtrs=0;
$branches=mysql_query("select distinct(orderto) from tbl_order_master where  orderto!='' and status!='Dispatched'");
...
$branchfinaltotalmtrs=0;
	...
	$parties=mysql_query("select distinct(orderby) from tbl_order_master where orderto='".$branchesrow['orderto']."' and status!='Dispatched'");
	while($partiesrow=mysql_fetch_array($parties))
	{
		
		$str=mysql_query("select * from tbl_order_master where  orderby='".$partiesrow['orderby']."'  and orderto='".$branchesrow['orderto']."' and status!='Dispatched' ORDER BY id desc");
...
$branchfinaltotalmtrs=0;
	...
	$parties=mysql_query("select distinct(orderby) from tbl_order_master where  orderto='' and status!='Dispatched'");
	while($partiesrow=mysql_fetch_array($parties))
	{
		
		$str=mysql_query("select * from tbl_order_master where  orderby='".$partiesrow['orderby']."' and status!='Dispatched'  and orderto='' ORDER BY id desc");
		//echo "select * from tbl_order_master where status!='Dispatched' and orderby='".$partiesrow['orderby']."' ORDER BY id desc";
?>
