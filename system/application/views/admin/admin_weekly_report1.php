...
<script type="text/javascript" src="<?php echo  base_url();?>js/daterangepicker.jQuery.js"></script>
		<link rel="stylesheet" href="<?php echo  base_url();?>css/ui.theme.css" type="text/css" />
		<link rel="stylesheet" href="<?php echo  base_url();?>css/jquery-ui-daterangepicker.css" type="text/css" />
<script type="text/javascript">
...
var customer=document.getElementById('rangeA').value
...
//alert(value);
if(value!='')
var da=value[0]+":"+value[1]+":"+value[2]+":"+value[3]+":"+value[4];
else
da=='';
//alert(da);
...
var url=base_url+'admin/admin_reports/weeklyreports/'+da;
//url=url+"&q="+str;
//alert(url);
//alert(url);
...
//alert(dat1);
window.location.href=base_url+'admin/admin_reports/weeklyreportview/'+dat1;
...
<script type="text/javascript">	
			$(function(){
				  $('#rangeA').daterangepicker({arrows: true, dateFormat: 'mm/dd/yy'}); 
			 })
		</script>	
...
<tr><td class="heading" style="padding-top:30px;">Weekly Report</td>
<td align="right" style="padding-right:25px;"><a href=" <?php echo base_url(); ?>index.php/admin/admin_orders/weeklyordersprintview/<?php echo $str2?>" target="_blank"><img src="<?php echo base_url(); ?>images/print.gif"  style="border:none"/></a></td></tr>

<tr><td id=error align="center" style="font-family:Tahoma, Geneva, sans-serif; color:red;"></td></tr>

<tr><td  style="padding-top:20px;padding-left:80px;" width="20%">Date Range</td><td style="padding-top:20px;">
<input type="text" value="<?php echo $str1[0]."-".$str1[1]; ?>" id="rangeA"/></td></tr>
...
//session_start();
// $_SESSION['dat'];
//echo "select * from tbl_order_master where orderdate='".$vars."' ORDER BY id desc";
//echo "select * from tbl_order_master where orderdate between '".$str1[0]."' and '".$str1[1]."' ORDER BY id";
$str=mysql_query("select * from tbl_order_master where orderdate between '".$str1[0]."' and '".$str1[1]."' ORDER BY id");
