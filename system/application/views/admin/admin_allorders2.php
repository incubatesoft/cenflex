...
<td align="right" style="padding-right:25px;"><a href=" <?php echo base_url(); ?>index.php/admin/admin_orders/allordersprintview/<?php echo $vars?>" target="_blank"  id="print"><img src="<?php echo base_url(); ?>images/print.gif"  style="border:none;"/></a></td></tr>
...
{ //alert('hi');
	...
	if(obj == "ho")
	{
			$.ajax({
			type: "POST",
			url: base_url+"admin/admin_reports/all_ho_reports/",
		 //	data: query_str,
			beforeSend: function(){
	...
	$.ajax({
			type: "POST",
			url: base_url+"admin/admin_reports/all_reports/"+obj,
		 //	data: query_str,
			beforeSend: function(){
				document.getElementById('dynamictable').innerHTML = "<img src='<?php echo base_url(); ?>images/loading2.gif' alt='loading'  />";				  
			// $("#add_admin_shipping1 .frmholder").html($(".spinner").clone());
...
?>	
<option value="ho">Others (H.O)</option>
</select>
