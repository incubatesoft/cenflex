...
//alert(gr); 
    ...
    url:base_url+'admin/admin_vehiclegrid',
    ...
    colNames:['id','Vehicle Number','Driver Name','Mobile Number','Transport Name','Edit','Delete'],
    ...
    colModel:[
        ...
        {name:'vehiclenum',index:'vehiclenum', width:120,editable:true},
		 {name:'drivername',index:'drivername', width:120,editable:true},
		  {name:'mobilenumber',index:'mobilenumber', width:110,editable:true},
		   {name:'transportname',index:'transportname', width:110,editable:true},
...
$("#dialog_message").dialog(
{
		...
		buttons: { 
				"Ok": function() 
				{
					...
					$.ajax({
					type: "POST",
					url: base_url+"admin/admin_modules/vehicle_delete/"+jQuery("#list5").getGridParam('selrow'),			 
					beforeSend: function()
					{
				 ...
				 //alert(html);
					...
					if(html=="Items exsist under this Product.")
					{
					//alert(html);
					return false;
					}
...
function  delete_vehicle(obj)
{
		...
		var msg="Are you sure you want to delete vehicle id  "+obj + "?";
 ...
 function  edit_vehicle(obj)
 {
		...
		$("#add_admin_shipping .modal_title").html("Edit Vehicle");
		
		  var query_str = "";
		  	$.ajax({
			type: "POST",
			url: base_url+"admin/admin_modules/editvehicle/"+obj,
		 //	data: query_str,
			beforeSend: function(){
