...
<script type="text/javascript">	
			$(function(){
				  $('#rangeA').daterangepicker({arrows: true, dateFormat: 'dd/mm/yy'}); 
			 })
		</script>	
...
<tr><td id=error align="center" style="font-family:Tahoma, Geneva, sans-serif; color:red;" colspan="2"></td></tr>

<tr><td  style="padding-top:20px;padding-left:80px;" width="20%">Data Range</td><td style="padding-top:20px;"><input type="text" value="Choose a Date" id="rangeA"/></td></tr>
