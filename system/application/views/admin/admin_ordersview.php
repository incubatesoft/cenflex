...
//alert(gr); 
    ...
    url:base_url+'admin/admin_ordersgrid',
    ...
    colNames:['DO Number','Order Date','Order From','Priority','Remarks','Authorised Person','Status','Edit','Active/Deactive'],
    ...
    colModel:[
		...
		{name:'send',index:'send', width:100,editable:true},
