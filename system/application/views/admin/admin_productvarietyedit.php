...
//alert("hi");
	...
	$.ajax({
		type: "POST",
		 url: base_url+'admin/admin_modules/productsvarietyupdate',
		data: $('#productsvarietyForm').serialize(),
		
		success: function(msg)
		{
		//alert(msg);	
		if(msg=="Product variety Updated Successfully.")
				{
...
<?php
$res_var=mysql_query("select *from tbl_item_varieties where id=".$vars);
...
<fieldset style="border:1px solid #073c68"><legend><b>Product&nbsp;Varieties&nbsp;Registration</b></legend>
...
<tr><td>Product Variety:</td><td style="padding-left:30px"><input type="text" size="30" name="pvname" id="pvname" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; border:1px solid #073c68" value="<?php echo $row_var['variety']?>"></td></tr>
