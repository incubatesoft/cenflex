...
<tr><td class="heading" style="padding-top:30px;">Branchwise Orders Report</td><td align="right" style="padding-right:20px; padding-top:20px;"><a href="<?php echo base_url(); ?>index.php/admin/admin_orders/pendingordersprintview/<?php echo $vars?>" target="_blank" id="print" ><img src="<?php echo base_url(); ?>images/print.gif"  style="border:none"/></a></td></tr>
...
{ //alert('hi');
	...
	$.ajax({
			type: "POST",
			url: base_url+"admin/admin_reports/branchwise_report/"+obj,
		 //	data: query_str,
			beforeSend: function(){
