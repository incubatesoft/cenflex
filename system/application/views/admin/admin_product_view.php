...
//alert(gr); 
    ...
    url:base_url+'admin/admin_itemgrid',
    ...
    colNames:['id','Product Code','Product Name','Units','Edit','Delete'],
    ...
    colModel:[
        ...
        {name:'itemcode',index:'itemcode', width:120,editable:true},
		 {name:'itemname',index:'itemname', width:120,editable:true},
		  {name:'unit',index:'unit', width:110,editable:true},
...
$("#dialog_message").dialog(
{
		...
		buttons: { 
				"Ok": function() 
				{
					...
					$.ajax({
					type: "POST",
					url: base_url+"admin/admin_modules/product_delete/"+jQuery("#list5").getGridParam('selrow'),			 
					beforeSend: function()
					{
...
function  delete_product(obj)
{
		...
		var msg="Are you sure you want to delete Product "+obj + "?";
 ...
 function  edit_product(obj)
 {
		...
		$("#add_admin_shipping .modal_title").html("Edit Product");
		
		  var query_str = "";
		  	$.ajax({
			type: "POST",
			url: base_url+"admin/admin_modules/Editproduct/"+obj,
		 //	data: query_str,
			beforeSend: function(){
