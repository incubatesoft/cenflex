...
//alert("hi");
	...
	$.ajax({
		type: "POST",
		 url: base_url+'admin/admin_modules/productssubmit',
		data: $('#productsForm').serialize(),
		
		success: function(msg)
		{
			if(msg=='Product Registered Successfully.')
{
...
<tr><td class="navcontbg1" ><a href=" <?php echo base_url(); ?>index.php/admin/admin_modules/productsvariety">Product Varieties</a>
<tr><td class="navcontbg2" ><a href=" <?php echo base_url(); ?>index.php/admin/admin_modules/productsdensity">Product Density</a>
<tr><td class="navcontbg1" ><a href=" <?php echo base_url(); ?>index.php/admin/admin_modules/vehicle">Vehicle</a></td></tr>
...
<tr><td align="right" style="padding-right:100px; padding-top:20px;"><a href=" <?php echo base_url(); ?>index.php/admin/admin_modules/productview"><img src="<?php echo base_url(); ?>images/vvv.gif"  style="border:none"/></a></td></tr>

<tr><td class="success" id=success ></td></tr>
<tr><td>
<form name="productsForm" id="productsForm" action="" method="post">
<fieldset style="border:1px solid #073c68;width:400px;"><legend><b>Product&nbsp;Registration</b></legend>
<table  cellpadding="3" cellspacing="1" height="100%">
<tr><td>Product Code:</td><td style="padding-left:30px"><input type="text" size="30" name="pcode" id="pcode" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; border:1px solid #073c68 " /></td></tr>
<tr><td>Product Name:</td><td style="padding-left:30px"><input type="text" size="30" name="pname" id="pname" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; border:1px solid #073c68" /></td></tr>

<tr><td>Units:</td><td style="padding-left:30px"><input type="text" size="30" name="punit" id="punit" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; border:1px solid #073c68"/></td></tr>
