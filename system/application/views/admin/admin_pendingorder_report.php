...
$branchfinaltotalmtrs=0;
	...
	$parties=mysql_query("select distinct(orderby) from tbl_order_master where status!='Dispatched' and orderto='".$branchesrow['orderto']."'");
	while($partiesrow=mysql_fetch_array($parties))
	{
		
		$str=mysql_query("select * from tbl_order_master where status!='Dispatched' and orderby='".$partiesrow['orderby']."'  and orderto='".$branchesrow['orderto']."'ORDER BY id desc");
