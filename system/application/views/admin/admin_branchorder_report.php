...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>js/jquery.dataTables1.js"></script>
...
<tr><td class="heading" style="padding-top:30px;">Branchwise Orders Report</td><td align="right" style="padding-right:20px; padding-top:20px;"><a href="<?php echo base_url(); ?>index.php/admin/admin_orders/pendingordersprintview/<?php echo $vars?>" target="_blank"><img src="<?php echo base_url(); ?>images/print.gif"  style="border:none"/></a></td></tr>
...
echo"<tr class=odd><td colspan=3  style='color:red;'><b>Total Bundles/Meters (".$branchesrow['orderto']." Depot) </td><td style='color:red;'><b>".$branchfinaltotalbundles."/".$branchfinaltotalmtrs."</b></td><td style='color:red;'><b>".$branchtotaldispatched."/".$branchtotaldispatchedmtrs."</b></td><td style='color:red;'><b>".$branchtotalpendingbundles."/".$branchtotalpendingmtrs."</b></td><td></td></tr>";
	...
	echo "<tr class=even><td colspan=3 style='color:#960;'><b>Total Bundles/Meters </td><td style='color:#960;'><b>".$allfinaltotalbundles."/".$allfinaltotalmtrs."</b></td><td style='color:#960;'><b>".$alltotaldispatched."/".$alltotaldispatchedmtrs."</b></td><td style='color:#960;'><b>".$alltotalpendingbundles."/".$alltotalpendingmtrs."</b></td><td></td></tr>";
?>
