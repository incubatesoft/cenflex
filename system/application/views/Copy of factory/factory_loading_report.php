...
<tr><td class="heading" style="padding-top:30px;">All Orders Loading Details</td>
<td align="right" style="padding-right:30px;"><a href=" <?php echo base_url(); ?>index.php/admin/admin_orders/loadingordersprintview/<?php echo $vars?>" target="_blank"><img src="<?php echo base_url(); ?>images/print.gif"  style="border:none"/></a> </td></tr>
<tr><td colspan="2">
<div id="container">
	<div id="demo">
<table cellpadding="3"  class="display KeyTable" id="example" style='border: 1px solid #8A0A37;'  width=100% >
...
<tr><th nowrap="nowrap">Bundle No</th><th width=140 align=center nowrap="nowrap">Loading Date</th><th width=150 align=center>Vehicle</th><th nowrap="nowrap">DO No</th><th nowrap="nowrap">Order Date</th><th>Party</th><th nowrap="nowrap">Variety</th><th nowrap="nowrap">Size</th></tr>
</thead><tbody>
<?php
$str=mysql_query("select *from tbl_loadingadvice");
...
echo "<tr><td id='confirm-dialog' align=center>".$row['bundlenum']."</td><td id='confirm-dialog' nowrap>".$row['dateofloading']."</td><td id='confirm-dialog' nowrap>".$row['vehiclenumber']."</td><td id='confirm-dialog'><a onClick=order_details('$row_order[id]')>".$row['donum']."</a></td><td id='confirm-dialog'>".$row_order['orderdate']."</td><td id='confirm-dialog' style='padding-left:10px;'>".$row_order['orderby']."</td><td id='confirm-dialog' align=center>".$row_details['variety']."</td><td id='confirm-dialog' align=center nowrap>".$size."</td></tr>";
