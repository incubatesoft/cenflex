...
//alert(gr); 
    ...
    colNames:['Sno','Name','Mobile','City','State','UserName','Password'],
...
if($row['user']=='Yes')
{
	echo "<td align='center' class='mainnavlink' ><a href=".base_url()."index.php/factory/factory_users>Users</a></td>";
}
if($row['orders']=='Yes')
{
...
<tr>
  <td colspan="2">
<table width="1107" height="635">
<tr><td width="279" valign="top" style="padding-left:10px;width:270px; padding-top:5px;">

<table cellpadding="0" cellspacing="0">

<tr><td class="navhdr"><b>Quick Links</b></td></tr>
<tr><td class="navcontbg1" ><a href=" <?php echo base_url(); ?>index.php/factory/factory_users">User Creation</a></td></tr>
<tr><td class="navcontbg2" ></td></tr>
<tr><td class="navcontbg2" ></td>
<tr><td class="navcontbg2" ></td></tr>
<tr><td class="navcontbg2" ></td></tr>
<tr><td class="navcontbg2" ></td></tr>
<tr><td class="navcontbg2" ></td></tr>
