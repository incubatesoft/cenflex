...
//alert(gr); 
    ...
    url:base_url+'factory/factory_ordersgrid',
    ...
    colNames:['DO Number','Order Date','Customer Type','Order From','Required Dispatched Time','Send'],
    ...
    colModel:[
		...
		{name:'usertype',index:'usertype', width:130,editable:true},
		{name:'orderby',index:'orderby', width:130,editable:true},
		{name:'priority',index:'priority', width:170,editable:true},
...
function  delete_order(obj)
{
 ...
 function  send_order(obj)
 {
		...
		$("#add_admin_shipping").width(650).height(500);
...
<tr >
<td align="center" class="mainnavlink" ><a href='<?php echo base_url(); ?>index.php/factory/factory_users'  >Users</a></td>
