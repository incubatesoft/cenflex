...
<tr><th nowrap="nowrap">DO No</th><th nowrap="nowrap">Order Date</th><th>Branch</th><th>Party</th><th nowrap="nowrap">Total Bundles</th><th>Dispatched</th><th nowrap="nowrap">Pending</th><th width=150 align=center>Status</th></tr>
</thead><tbody>
<?php
$str=mysql_query("select * from tbl_order_master where status!='Dispatched' and status!='New' and orderto!='' ORDER BY id desc");
