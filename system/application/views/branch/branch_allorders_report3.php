...
$branchfinaltotalmtrs=0;
	...
	$str=mysql_query("select * from tbl_order_master where  orderby='".$partiesrow['orderby']."'  and orderto='".$row_branch['branchname']."' ORDER BY id desc LIMIT ".$start.", 10");
		//echo "select * from tbl_order_master where orderby='".$partiesrow['orderby']."'  and orderto='".$row_branch['branchname']."' ORDER BY id desc  LIMIT ".$start.", 10";
?>
