...
//alert("hi");
	...
	$.ajax({
		type: "POST",
		 url: base_url+'branch/branch_orders/ordersubmit',
...
<tr><td class="navcontbg1" ><a href=" <?php echo base_url(); ?>index.php/branch/branch_orders">Create Orders</a></td></tr>
<!--<tr><td class="navcontbg2" ><a href=" <?php echo base_url(); ?>index.php/branch/branch_orders/sendtofactory">Sending Orders</a></td></tr>-->
<tr><td class="navcontbg2" ></td></tr><tr><td class="navcontbg2" ></td></tr>
...
<tr><td align="right" style="padding-right:20px; padding-top:20px;"><a href=" <?php echo base_url(); ?>index.php/branch/branch_orders/branchordersview"><img src="<?php echo base_url(); ?>images/vvv.gif"  style="border:none"/></a></td></tr>
...
<td style="padding-left:30px;" colspan=5 >Branch
<!--<select name="customertype" id=customertype onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF;width:190px;" onchange="showusers()">
...
<input name="customertype" id=customertype type="text" value="Branch" style=" visibility:hidden" />
<tr><td colspan=6>
<div name="selectuser" id="selectuser" style="">
<table border=0 width=100%>
<tr><td colspan="2" nowrap="nowrap" width="23%">Order From:</td><td style="padding-left:30px" colspan=5>
<?php $user=$this->db_session->userdata('u_name'); echo $user;
//$userdet=mysql_query("select * from tbl_branches where username='".$user."' ");
//$userdetails=mysql_fetch_array($userdet);
?>

<input name="orderfrom" id=orderfrom  type="text" value="<?php echo $user;?>" style="visibility:hidden">
<!--<select name="orderfrom" id=orderfrom onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF;width:190px;" onchange="selectuser()">
...
<td nowrap='nowrap'><input type=text size=5 name=slen_".$j." id=slen_".$j."  maxlength='6'  onkeyup = 'digitsOnly(this)'><select name=slentype_".$j." id=slentype_".$j."><option>Inch</option><option>mm</option></select></td>



<td nowrap='nowrap'><input type=text size=5 name=swid_".$j." id=swid_".$j." maxlength='6'  onkeyup = 'digitsOnly(this)'><select name=swidtype_".$j." id=swidtype_".$j."><option>Inch</option><option>mm</option></select></td>
...
<td><input type=text size=5 name=squa_".$j." id=squa_".$j."  maxlength='6'  onblur=numbundles(this.value,this.id,'Sheets') onkeyup =digitsOnly(this);numbundles(this.value,this.id,'Sheets')></td>
...
<td ><input type=text size=7 name=scolor_".$j." id=scolor_".$j."  value='Standard'></td>
 <td></td> 
    ...
    <tr>
<td idth=10><a id="addnew" href="">Add</a></td> 
<td>
...
<td><input type=text size=5 name=slen_5 id=slen_5 maxlength='6' onkeyup ='digitsOnly(this)'><select name=slentype_5 id=slentype_5><option>Inch</option><option>mm</option></select></td>



<td><input type=text size=5 name=swid_5 id=swid_5 maxlength='6' onkeyup ='digitsOnly(this)'><select name=swidtype_5 id=swidtype_5><option>Inch</option><option>mm</option></select></td>
...
<td><input type=text size=5 name=cqua_".$i." id=cqua_".$i." maxlength='6'  onkeyup =digitsOnly(this);numcushions(this.value,this.id) onblur=numcushions(this.value,this.id)></td>
...
<td nowrap="nowrap"><input type=text size=5 name=clen_5 id=clen_5 maxlength='6' onkeyup = 'digitsOnly(this)'><select name=clentype_5 id=clentype_5><option>Inch</option><option>mm</option></select></td>
...
<td><input type=text size=5 name=rthi_".$j." id=rthi_".$j." maxlength='6' onkeyup = 'digitsOnly(this)'></td>
