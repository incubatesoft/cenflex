...
$branchfinaltotalmtrs=0;
	...
	while($partiesrow=mysql_fetch_array($parties))
	{
		...
		$str=mysql_query("select * from tbl_order_master where  orderby='".$partiesrow['orderby']."'  and orderto='".$row_branch['branchname']."' and status!='Dispatched' ORDER BY id desc  LIMIT ".$start.", 10");
		//echo "select * from tbl_order_master where  orderby='".$partiesrow['orderby']."'  and orderto='".$row_branch['branchname']."' and status!='Dispatched' ORDER BY id desc  LIMIT ".$start.", 10";
?>
