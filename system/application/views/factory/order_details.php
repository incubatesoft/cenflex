...
<table  cellpadding="3" cellspacing="0" height="97%" width=100% border="0">
...
<tr><td nowrap="nowrap" colspan="4"><b>Billing Price: </b><?php echo $row_var['billingprice'] ?></b></td></tr>
...
//echo "select * from tbl_orders where donum='".$row_var['donum']."' and itemname='Rolls'";
...
<div style="float:left;width:50px; margin-top:0px; margin-left:220px; font-family:Arial, Helvetica, sans-serif; font-size:13px;">
<a href=" <?php echo base_url(); ?>index.php/admin/admin_orders/printview/<?php echo $vars?>" target="_blank"><img src="<?php echo base_url(); ?>images/print.gif"  style="border:none"/></a>
</div>
