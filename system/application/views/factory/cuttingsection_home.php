...
//alert(gr); 
        ...
        colNames:['DO Number','Party Name','Item','Density','Variety','Length','Width','Thickness','Bundles','Quantity','Package Type','Remarks','Color','Package'],
        ...
        colModel:[
            ...
            {name:'orderby',index:'orderby', width:100,editable:true},
            {name:'itemname',index:'itemname', width:80,editable:true},
            {name:'density',index:'density', width:80,editable:true},
            ...
            {name:'mtrsleft',index:'mtrsleft', width:60,editable:true},
            {name:'packagetype',index:'packagetype', width:90,editable:true},
            {name:'remarks',index:'remarks', width:90,editable:true},
            {name:'colorspecific',index:'colorspecific', width:60,editable:true},
