...
//alert(gr); 
    ...
    url:base_url+'factory/factory_newordersgrid',
    ...
    colNames:['DO Number','Order Date','Order From','Priority','Remarks','Authorised Person','Status','Active/Deactive'],
    ...
    colModel:[
        ...
        {name:'donum',index:'donum', width:70,editable:true},
		{name:'orderdate',index:'orderdate', width:80,editable:true},
		{name:'orderby',index:'orderby', width:120,editable:true},
		{name:'priority',index:'priority', width:140,editable:true},
		{name:'remarks',index:'remarks', width:140,editable:true},
		{name:'authorisedname',index:'authorisedname', width:120,editable:true},
		{name:'status',index:'status', width:140,editable:true},
...
$("#dialog_message").dialog(
{
		...
		buttons: { 
				"Ok": function() 
				{
					...
					$.ajax({
					type: "POST",
					url: base_url+"admin/admin_orders/order_deactive/"+$("#delete_idval").val(),			 
					beforeSend: function()
					{
...
if($row['user']=='Yes')
{
	echo "<td align='center' class='mainnavlink' ><a href=".base_url()."index.php/factory/factory_users/usercreation>Creation</a></td>";
}
if($row['orders']=='Yes')
{
