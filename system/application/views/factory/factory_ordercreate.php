...
//alert("hi");
	...
	$.ajax({
		type: "POST",
		 url: base_url+'factory/factory_users/ordersubmit',
...
<tr><td align="right" style="padding-right:20px; padding-top:20px;"><a href=" <?php echo base_url(); ?>index.php/factory/factory_users/ordersview"><img src="<?php echo base_url(); ?>images/vvv.gif"  style="border:none"/></a></td></tr>
...
<td><input type=text size=5 name=cqua_".$i." id=cqua_".$i." maxlength='6'  onblur=numcushions(this.value,this.id)  onkeyup=digitsOnly(this);numcushions(this.value,this.id)></td>
...
<td ><input type=text size=7 name=cremarks_".$i." id=cremarks_".$i." ></td>
...
<td nowrap="nowrap"><input type=text size=5 name=clen_5 id=slen_5 maxlength='6' onkeyup = 'digitsOnly(this)'><select name=clentype_5 id=clentype_5><option>Inch</option><option>mm</option></select></td>
