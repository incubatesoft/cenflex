...
var url=base_url+'factory/factory_reports/dialyreports/'+da;
//url=url+"&q="+str;
//alert(url);
//alert(url);
...
//alert(dat1);
window.location.href=base_url+'factory/factory_reports/dialyreportview/'+dat1;
...
<tr><td class="heading" style="padding-top:30px;" colspan="2">Day wise Orders Report</td></tr>

<tr><td id=error align="center" style="font-family:Tahoma, Geneva, sans-serif; color:red;"></td></tr>

<tr><td  style="padding-top:20px; padding-left:180px;"> Select Date &nbsp;<input type="text" size="26" name="rdate" id="rdate" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; " value=''></td></tr>
