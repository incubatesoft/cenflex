...
//alert(dat1);
window.location.href=base_url+'admin/admin_reports/loadingreportfactoryview/'+dat1;
...
<td class="rightpane" valign=top style="padding-right:60px;">


<table width="100%" cellpadding="0" cellspacing="0" border="0">

<tr><td class="heading" style="padding-top:30px;">Loading Orders Report</td></tr>

<tr><td id=error align="center" style="font-family:Tahoma, Geneva, sans-serif; color:red;" valign="top"></td></tr>
<tr><td  style="padding-top:20px; padding-left:180px;" valign="top"> Select Date &nbsp;<input type="text" size="26" name="rdate" id="rdate" onfocus="this.style.background='#dce9fb'" onblur="this.style.background='#ffffff'" style="background-color:#FFFFFF; " value=''></td></tr>
...
$str=mysql_query("select * from tbl_order_master where orderdate='".$this->db_session->userdata('dat')."' ORDER BY id desc");
...
<tr><th colspan="3" style="font-size:12px; font-family:'Arial';">This page total Bundles</th><th align='center' id=ages name=ages style="font-size:12px;font-family:'Arial';"></th><th align='center' id=weights name=weights style="font-size:12px;font-family:'Arial';"></th>
<th align='center' id='benchpresses' name=benchpresses style="font-size:12px;font-family:'Arial';"></th><th></th></tr>
<tfoot>
